    ...
    <div class="w-full min-h-[232px] grid place-content-center mt-12 sm:mt-0">
      <div class="w-full flex flex-col gap-4">
        <div class="text-center sm:text-start grid gap-1">
          ...
          <h4>accès à votre compte</h4>
        </div>
        <div class="grid gap-4 mt-8">
          <btn-app text="Connectez-vous avec Google" @click="login('google')" icon="flat-color-icons:google" :loading="loading" class="min-w-fit mx-auto sm:mx-0"/>
        </div>
        <h6 class="w-8/12 sm:w-full mt-1 mb-4 mini-text text-center sm:text-start mx-auto sm:mx-0">cliquez sur « Google » pour vous inscrire ou vous connecter à votre compte</h6>
      </div>
    </div>
